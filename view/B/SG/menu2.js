...
<header id="header">\
            ...
            <nav>\
                <ul class="nav nav-pills nav-top">\
                    <li class="storeLocationMenu">\
                        <a href="/B/' +
    countryPrefix +
    '/storeLocation.html"><i class="icon icon-map-marker"></i>Store Location</a>\
                    </li>\
                    <li>\
                        <a href="/B/' +
    countryPrefix +
    '/memberLogin.html"><i class="icon icon-unlock-alt"></i>Login/Register</a>\
                    </li>\
                    <li>\
                        <a href="/B/' +
    countryPrefix +
    '/contactUs.html"><i class="icon icon-shopping-cart"></i>Contact Us</a>\
                    </li>\
                </ul>\
    ...
    '/storeLocation.html"><i class="icon icon-map-marker"></i>Store Location</a>\
                    ...
                    <li>\
                        <a href="/B/' +
    countryPrefix +
    '/shoppingCart.html"><i class="icon icon-shopping-cart"></i>Shopping Cart</a>\
                    </li>\
                    <li>\
                        <a href="/B/' +
    countryPrefix +
    '/memberProfile.html"><i class="icon icon-user"></i>Profile</a>\
                    </li>\
                    <li>\
                        <a href="/B/' +
    countryPrefix +
            ...
            <nav class="nav-main mega-menu">\
                <ul class="nav nav-pills nav-main" id="mainMenu">\
                    <li>\
                        <a href="/B/' +
    countryPrefix +
    '/virtualStore.html">Virtual Store</a>\
                    </li>\
                    <li class="dropdown">\
                        ...
                        <ul class="dropdown-menu">\
                            ...
                            <li><a href="/B/' +
    countryPrefix +
    '/furnitureCategory.html?cat=Bathroom"><i class="icon icon-map-marker"></i> Bathroom</a></li>\
